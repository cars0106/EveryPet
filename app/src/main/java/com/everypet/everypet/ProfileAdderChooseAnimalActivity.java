...
public class ProfileAdderChooseAnimalActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageCat = findViewById(R.id.prf_cat);
        imageCat.setOnClickListener(this);
        ImageView imageDog = findViewById(R.id.prf_dog);
        imageDog.setOnClickListener(this);
        ImageView imageFish = findViewById(R.id.prf_fish);
        imageFish.setOnClickListener(this);
        ImageView imageRabbit = findViewById(R.id.prf_rabbit);
        imageRabbit.setOnClickListener(this);
        ImageView imageSnake = findViewById(R.id.prf_snake);
        imageSnake.setOnClickListener(this);
        ImageView imageRat = findViewById(R.id.prf_rat);
        imageRat.setOnClickListener(this);
        ImageView imageEtc = findViewById(R.id.prf_etc);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull final MenuItem menuItem) {
                new AlertDialog.Builder(ProfileAdderChooseAnimalActivity.this)
    ...
    public void onClick(View view) {
        Intent intent = new Intent(getApplicationContext(), ProfileAdderWriteActivity.class);
